...
export default function Benifits() {
  ...
  return (
    ...
    <div className="blog__heading__section">
        <img src={benifits} alt=" red apple in bag " className='blog__heading__img' />
    ...
    <div className="blog__paragraph__section" style={{filter: scrolled? 'none': 'blur(3px)',transition:'0.3s all linear'}} >  
        ...
        <br /><br />
        n addition to their culinary versatility and numerous colors and flavors to choose from, apples are an exceptionally healthy fruit with many research-backed benefits.
        <br />
        <br />
        ...
        <br /><br />
          ...
          <br /><br />
          he current Dietary Guidelines for Americans recommend 2 cups of fruit daily for a 2,000-calorie diet, emphasizing whole fruits, like apples
          <br />
          <br />
          One medium 7-ounce (200-grams) apple offers the following nutrients
          <ul>
            <li><b>Calories:</b> 104</li>
            <li><b>Carbs:</b> 28 grams</li>
            <li><b>Fiber:</b> 5 grams</li>
            <li><b>Vitamin C:</b> 10% of the Daily value (DV)</li>
            <li><b>Copper:</b> 6% of the DV</li>
            <li><b>Potassium:</b> 5% of the DV</li>
            <li><b>Vitamin K:</b> 4% of the DV</li>
          ...
          <br />
            ...
            <h2>2. May support weight loss</h2>
          <br />
          ...
          <br />
            ...
            <h2>3. Could be good for your heart</h2>
          <br />
          ...
          <br />
            ...
            <h2>4. Linked to a lower risk of diabetes</h2>
            <br />
            ...
            <h2>5. May promote gut health</h2>
            <br />
            ...
            <h2>6. Might help prevent cancer</h2>
            <br />
            ...
            <h2>7. Could help fight asthma</h2>
            <br />
            ...
            <h2>8. May help protect your brain</h2>
            <br />
